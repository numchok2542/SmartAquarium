...
temperature = random.uniform(23.5,24.0)
pH = random.uniform(7.0,7.6)
...
print(f"Published new temperature measurement: {temperature}, and pH: {pH}")
time.sleep(1)
temp = ("%.1f",temperature)
pH2f = ("%.2f",pH)
print(f"measurement: {temp}, and pH: {pH2f}")
