...
class FeederWid extends StatefulWidget {
  @override
  _FeederWidState createState() => _FeederWidState();
}

class _FeederWidState extends State<FeederWid> {
  @override
  void initState() {
    mqconn();
    super.initState();
  ...
  //var client = MqttBrowserCLient("broker.emqx.io", "1883");
  //ip and port
 ...
 */
  ...
  Widget build(BuildContext context) {
    ...
    return Center(child:Column(children:[
      ...
      Text("Feeder Control", style: TextStyle(fontSize: 40, fontWeight: FontWeight.bold)),
      const SizedBox(height: 30),
      Text(feeder ? "Feeding" : "Closed", style: TextStyle(fontSize: 30)),
      const SizedBox(height: 30),
      InkWell(
            ...
            child: Container(
              ...
              child: Container(
                decoration: new BoxDecoration(
                  color: feeder ? Colors.greenAccent : Colors.red,
                  shape:
                  feeder ? BoxShape.rectangle : BoxShape.circle,
                  borderRadius: feeder
      ...
      const SizedBox(height: 30),
          ...
          Text("Instructions for feeding screen"),
          Container(child: Text("1.The feeder screen starts in a closed position")),
          Container(child: Text("2. Click feed to activate the feeder")),
          Container(child: Text("3. The feeder automatically deactivates after 5 seconds")),
